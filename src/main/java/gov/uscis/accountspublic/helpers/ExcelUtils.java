...
import gov.uscis.accountspublic.cucumber.BDDResultsSummary;
import gov.uscis.accountspublic.cucumber.BDDStepExecutionResult;
import gov.uscis.accountspublic.cucumber.BDDTestResult;

public class ExcelUtils {

	private static Logger logger = LoggerFactory.getLogger(ExcelUtils.class);
	private static final String RESULTS_TEMPLATE_FILE = "src/test/resources/customization/TestResults.xlsx";
	...
	public static void addStepExecutionResults ( Set<BDDStepExecutionResult> stepExecutionResults ) {
		try (
			FileInputStream excelFile = new FileInputStream(new File(RESULTS_FILE));
			XSSFWorkbook workbook = new XSSFWorkbook(excelFile);
			FileOutputStream resultsFile = new FileOutputStream(new File(RESULTS_FILE)) ) {
